...
export async function createAssistant(client: OpenAI): Promise<Assistant> {
    return await client.beta.assistants.create({
        ...
        instructions: `
           ...
           You are in control of a wallet on the CELO network that you can use to do whatever you want.
           You can use the following tools to interact  with the wallet: 
           - get_balance: Get the balance of a wallet (returns balance in CELO)
